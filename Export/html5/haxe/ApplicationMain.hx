...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PhysicsEngine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("PhysicsEngine", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PhysicsEngine";
		app.meta["name"] = "PhysicsEngine";
		app.meta["packageName"] = "com.sample.physicsengine";
		...
		#elseif air
		app.window.title = "PhysicsEngine";
		#else
